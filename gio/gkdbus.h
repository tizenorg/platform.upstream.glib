...
gboolean                                g_kdbus_open                      (GKdbus       *kdbus,
                                                                           ...
                                                                           GError      **error);
GLIB_AVAILABLE_IN_ALL
gboolean                                g_kdbus_try_close                 (GKdbus  *kdbus,
                                                                           GError **error);
GLIB_AVAILABLE_IN_ALL
gboolean                                g_kdbus_is_closed                 (GKdbus  *kdbus);
GLIB_AVAILABLE_IN_ALL
gsize                                   g_kdbus_receive                   (GKdbus        *kdbus,
                                                                           GCancellable  *cancellable,
                                                                           GError       **error);
GLIB_AVAILABLE_IN_ALL
gsize                                   g_kdbus_send                      (GDBusWorker   *worker,
                                                                           GKdbus        *kdbus,
...
GLIB_AVAILABLE_IN_ALL
gchar *                                 g_kdbus_get_last_msg_sender       (GKdbus  *kdbus);
GLIB_AVAILABLE_IN_ALL
gchar *                                 g_kdbus_get_last_msg_destination  (GKdbus  *kdbus);
