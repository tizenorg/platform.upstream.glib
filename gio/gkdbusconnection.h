...
gboolean           _g_kdbus_connection_is_connected              (GKdbusConnection  *connection);
...
gboolean           _g_kdbus_connection_close                     (GKdbusConnection  *connection,
                                                                  GCancellable      *cancellable,
                                                                  GError           **error);

void               _g_kdbus_connection_close_async               (GIOStream            *stream,
                                                                  int                   io_priority,
                                                                  GCancellable         *cancellable,
                                                                  GAsyncReadyCallback   callback,
                                                                  gpointer              user_data);

gboolean           _g_kdbus_connection_close_finish              (GIOStream     *stream,
                                                                  GAsyncResult  *result,
                                                                  GError       **error);
